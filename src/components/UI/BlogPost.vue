...
export default {
  data () {
    return {
      blogs: [
        {
          image: require('@/assets/images/blogs/travel-1.png')
        }
      ]
    }
  }
